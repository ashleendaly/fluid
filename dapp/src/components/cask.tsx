    ...
    return (
        <div className="relative w-full h-screen bg-purple-500 flex flex-col justify-center items-center">
            ...
            <div className="relative w-1/2 h-1/2 bg-white mx-auto flex flex-col justify-center items-center shadow-md border border-gray-700 rounded-sm">
                ...
                <h1 className="absolute top-0 left-0 p-6 mb-2 text-2xl font-bold tracking-tight text-gray-900">Cask Info:</h1>
                ...
                <div className="absolute left-7 top-60 flex flex-col justify-center items-center">
                    <div className="Buy">
                        ...
                        />
                        <button className="ml-10 p-4 px-6 py-3 bg-blue-500 text-white rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" onClick={handleBuyClick}>Buy</button>
                    </div>
                    <div className="Sell p-4">
                        ...
                        />
                        <button className="ml-10 p-4 px-6 py-3 bg-blue-500 text-white rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" onClick={handleSellClick}>Sell</button>
                    </div>
                </div>
            </div>
        </div>
