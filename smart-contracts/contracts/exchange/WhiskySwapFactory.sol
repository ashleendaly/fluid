...
contract WhiskySwapFactory is IWhiskySwapFactory {
    //
    ...
    /**
     * @notice Creates a WhiskySwap Exchange for given token contract
    ...
    function createExchange(address _token, address _currency, uint256 _currencyID) public override {
        require(
            ...
            "WhiskySwapFactory#createExchange: EXCHANGE_ALREADY_CREATED"
        );

        // Create new exchange contract
        WhiskySwapExchange exchange = new WhiskySwapExchange(_token, _currency, _currencyID);
